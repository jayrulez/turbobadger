...
TB_TEST_GROUP(tb_node_ref_tree)
{
	...
	TB_TEST(reference_value)
	{
		...
		TBWidget root;
		g_tb_context->GetWidgetsReader()->LoadData(&root, "TBButton: id: 'fire', skin: '@test_styles>FireButton>skin'");
	...
	TB_TEST(reference_value_recurse)
	{
		...
		TBWidget root;
		g_tb_context->GetWidgetsReader()->LoadData(&root,
	...
	TB_TEST(reference_include)
	{
		...
		TBWidget root;
		g_tb_context->GetWidgetsReader()->LoadData(&root,	"TBEditField: id: 'edit'\n"
	...
	{
		TBWidget root;
		g_tb_context->GetWidgetsReader()->LoadData(&root,	"SomeDeclarations\n"
											"	skin: 'SpecialSkin'\n"
											"	text: 'hello'\n"
											"TBEditField: id: 'edit'\n"
	...
	TB_TEST(reference_condition)
	{
		...
		// Inflate & check
		g_tb_context->GetWidgetsReader()->LoadData(&root1, layout_str);
		...
		// Inflate & check
		g_tb_context->GetWidgetsReader()->LoadData(&root2, layout_str);
